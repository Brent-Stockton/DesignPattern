...
/**Abstract class farm used for farm objects.*/
public abstract class Farm {
  ...
  //Getters and Setters for farm class.
  ...
  public int upgradeFarmers() {
    if (newPassiveCurrency == true) {
      ...
      System.out.println("Congrats you increase your "
              + "amount of farmers. Farmer employees are now " + numFarmers);
      return numFarmers;
    } else  {
